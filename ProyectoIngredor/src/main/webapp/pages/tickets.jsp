            ...
            <form action="Update.jsp">
              ...
              <div class="row g-2">
                <div class="col-12 col-md-6">
                  ...
                  <input type="text" name="cantidad" value="<%= request.getParameter("cantidad") %>" class="form-control" id="">
                </div>
                <div class="col-12 col-md-6">
              ...
              <div class="row g-3">
                <div class="col-12 col-md-4">
                  <button class="btn btn-compra" id="btnDelete" type="button">Delete</button>
                </div>
                <div class="col-12 col-md-4">
